...
export default function NewOrganizationForm(props: {}) {
  ...
  function submitHandler() {
    ...
    if (
      (orgName != undefined && !orgName.match(empty)) &&
      (orgPrice != undefined && !orgPrice.match(empty)) &&
      Number(orgPrice) >= 0 &&
      (orgDesc != undefined && !orgDesc.match(empty))
    ) {
      ...
      alert('Your organization must have a name, price (0 for free organizations), and description.')
    }
  }
  ...
  return (
    <>
      <div style={artListHeader.header}><p className="h8tch2">Create Organization</p></div>
      <Row>
        <Col>
